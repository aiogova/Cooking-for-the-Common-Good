...
if (distance_to_point(mouse_x,mouse_y) <= 0)
{
	...
	if(mouse_check_button_pressed(mb_left) && global.currentDishCount == 0 && global.day == 3 && global.dinner == true) {
		if(global.fishCount >= 2 && global.broccoliCount >= 1 && global.spinachCount >= 1) {
			global.currentDishCount++;
			global.grilledFishCount++;
			global.fishCount = global.fishCount - 2;
			global.broccoliCount--;
			global.spinachCount--;
			instance_create_layer(room_width/2,room_height/2,"Top",oMealCardGrilledFish);
