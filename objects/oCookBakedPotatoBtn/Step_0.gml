...
if (distance_to_point(mouse_x,mouse_y) <= 0)
{
	...
	if(mouse_check_button_pressed(mb_left) && global.currentDishCount == 0 && global.day == 1 && global.lunch == true) {
		if(global.potatoCount >= 2) {
			global.currentDishCount++;
			global.bakedPotatoCount++;
			global.potatoCount = global.potatoCount - 2;
			instance_create_layer(room_width/2,room_height/2,"Top",oMealCardBakedPotato);
